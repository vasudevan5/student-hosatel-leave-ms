                             ...
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            <thalign="center">Action</th>
                                        </tr>
                                    </thead>
                                 
                                    <tbody>
<?php $sql ="SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StuId,tblstudents.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblstudents on tblleaves.empid=tblstudents.id where tblleaves.empid='$eid' order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="dashboard.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?>(<?php echo htmlentities($result->StuId);?>)</a></td>
