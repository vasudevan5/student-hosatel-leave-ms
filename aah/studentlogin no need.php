...
$sql ="SELECT StuId,Password,Status,id FROM tblstudent  WHERE StuId=:uname and Password=:password";
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">AAH Hostel Student Leave Management System</span>
                        </div>
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to AAH poratl</h4></div>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="input-field col s12">
                                                   ...
                                                   <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Student Password Recovery</a></li>
                                               </div>
