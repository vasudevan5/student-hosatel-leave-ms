            ...
            <main class="mn-inner">
                <div class="">
                    <div class="row no-m-t no-m-b">
                        <a href="managestudent.php" target="blank">
                        ...
                        <div class="col s15 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StuId,tblstudents.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblstudents on tblleaves.empid=tblstudents.id order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="editstudent.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?>(<?php echo htmlentities($result->StuId);?>)</a></td>
