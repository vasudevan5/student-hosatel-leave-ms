      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Student Name :</b></td>
                                              <td><a href="editstudent.php?empid=<?php echo htmlentities($result->id);?>" target="_blank">
