                ...
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div class="sidebar-profile-image">
                            <img src="assets/images/face8.jpg" class="circle" alt="">
                        </div>
                        <div class="sidebar-profile-info">
                    <?php 
$eid=$_SESSION['eid'];
$sql = "SELECT FirstName,LastName,StuId from  tblstudents where id=:eid";
...
{               ?>  
                                ...
                                <span><?php echo htmlentities($result->StuIdId)?></span>
                         <?php }} ?>
                        </div>
                    </div>
...
<!--  <li class="no-padding"><a class="waves-effect waves-grey" href="myprofile.php"><i class="material-icons">account_box</i>My Profiles</a></li>-->
  <li class="no-padding"><a class="waves-effect waves-grey" href="stu-changepassword.php"><i class="material-icons">settings_input_svideo</i>Chanage Password</a></li>
                    <li class="no-padding">
