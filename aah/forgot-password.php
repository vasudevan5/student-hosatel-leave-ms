...
.succWrap{
    ...
    <body style="background-image: url('./img/hostel.jpg');">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4 style="color:powderblue;">Student  Password Recovery</h4></div>
                        <div class="col s12 m6 l4 offset-l0 offset-m3" style="padding-top:7%;">
                          <!-- <div class="col s12 m6 l8 offset-4 offset-m8"> -->
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tblstudents WHERE EmailId=:email and StuId=:empid";
